...
interface Obfuscator {
    ...
    String SnapEventKlass = "qgs"; // find the file with "-FirstFrame" in it
    ...
    String MediaCacheEntryKlass = "qli"; // find the file with ("mCache", this.a).a("mKey", this.b) in it
    String MediaCacheEntryConstructorFirstParam = "svs"; // public qli(svs svs, String str) {this(svs, str, null, false);}
    // Encryption
    ...
    // Root detection
    String RootDetectorKlass = "ryz"; // "/sbin/su", "/system/bin/su",
